...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiYWx2b25qIiwiYSI6ImNsZDZ3ajhjYzBqaHUzbnFoOTdta2JkZHIifQ.PUXXr4Uiawpnvg6wWnanCw';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/alvonj/cld6wqu94000901lnojluitv6',
    scrollZoom: false
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        ...
        case 3:
          res = _context3.sent;
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', 'Register successful!');
            window.setTimeout(function () {
              location.assign('/');
            }, 1000);
          }
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }
var stripe = Stripe('pk_test_51MTkkGITe0epezbX1cz54enaOvcVqoilHx9GQy2vviTfnTz1I6uhTf8Q4LZURF01EHCrNng0nhrDGYYRDxmSbhn400fQqF1bx3');
...
if (registerForm) {
  registerForm.addEventListener('submit', function (ev) {
    ...
    (0, _login.register)(name, email, password, confirmationPassword);
  });
}
if (logOutBtn) logOutBtn.addEventListener('click', _login.logout);
if (userDataForm) userDataForm.addEventListener('submit', function (ev) {
  ev.preventDefault();
...
if (bookBtn) bookBtn.addEventListener('click', function (ev) {
